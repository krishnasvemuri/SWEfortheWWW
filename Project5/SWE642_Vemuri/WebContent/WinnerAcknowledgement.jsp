...
<br />
<h4>Mean for data you have entered : ${stm.getMean() }<br/>
Standard Deviation: ${stm.getStandardDeviation() }<br/>
</h4>
	
	<ul>
		<%
		String[] idstring = (String[])request.getAttribute("idList");
		
		
			for (int i=0;i<idstring.length;i++) {
			String stuid = idstring[i];
		%>		
		<li><a href="/SWE642_Vemuri/student?id=<%=stuid%>"><%=stuid%></a></li>	
		<%
			}
		%>
	</ul>
